...
class TimerDebouncer : public ButtonDebouncer {
public:
	 TimerDebouncer() = delete;

	 TimerDebouncer (TIM_TypeDef *timer, uint16_t timer_prescaler, uint16_t debounce_time)
...
public:
	...
	BUTTON(GPIOPIN gpio_pin, uint8_t active_state, ButtonDebouncer* debouncer = nullptr,  uint16_t long_press_time = 0);
